  ...
  <Page auto-content-height>
    ...
    <Grid>
      <template #toolbar-actions>
        <Button v-auth="['demo:product:create']" type="primary" @click="handleCreate">新建</Button>
        <Button v-auth="['demo:product:batch-delete']" danger class="ml-2" @click="handleBatchDelete">批量删除</Button>
        <Button v-auth="['demo:product:export']" class="ml-2" @click="handleExport">导出</Button>
        <Button v-auth="['demo:product:import']" class="ml-2" @click="handleImportTrigger">导入</Button>
        <Button class="ml-2" @click="handleDownloadTemplate">模板下载</Button>
        <Button v-auth="['demo:product:batch-update']" class="ml-2" @click="handleBatchUpdateStatus">批量修改状态</Button>
      </template>
      ...
      <template #action="{ row }">
        <Button v-auth="['demo:product:detail']" type="link" size="small" @click="handleView(row)">查看</Button>
        <Button v-auth="['demo:product:update']" type="link" size="small" @click="handleEdit(row)">编辑</Button>
        <Button v-auth="['demo:product:delete']" type="link" danger size="small" @click="handleDelete(row)">删除</Button>
      </template>
    </Grid>
  </Page>
</template>
