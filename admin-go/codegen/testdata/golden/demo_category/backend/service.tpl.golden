...
type ICategory interface {
	...
	Export(ctx context.Context, in *model.CategoryListInput) (list []*model.CategoryListOutput, err error)
	Tree(ctx context.Context, in *model.CategoryTreeInput) (tree []*model.CategoryTreeOutput, err error)
	BatchUpdate(ctx context.Context, in *model.CategoryBatchUpdateInput) error
}
